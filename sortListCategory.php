...
$query = "SELECT * FROM `product` WHERE status_id = '1' AND category_id = '" . $search . "'";
    ...
    <ul>
        <li>
            <a <?php if ($pageno <= 1) {
                ...
                ?> onclick="sortListCategory('<?php echo $search; ?>','<?php echo ($pageno - 1); ?>');" <?php } ?>>
        ...
        ?>
                ...
                <li>
                    <a class="active" onclick="sortListCategory('<?php echo $search; ?>','<?php echo ($v); ?>');"><?php echo $v; ?></a>
                </li>
            ...
            ?>
                ...
                <li>
                    <a onclick="sortListCategory('<?php echo $search; ?>','<?php echo ($v); ?>');"><?php echo $v; ?></a>
                </li>
