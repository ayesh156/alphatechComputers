...
<!-- Start Modal Add wishlist -->
<div class="modal fade" id="modalAddWishlist" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="modal-add-text">
                                ...
                                <div class="modal-add-cart-info"><i class="fa fa-check-square"></i>Added to wishlist
                                    successfully!</div>
