...
if (isset($_SESSION["a"])) {
    ...
    if ($category == "0") {
        ...
        if ($length <= 4 && $length > 0) {
            ...
            Database::iud("INSERT INTO `product` (`category_id`,`brand_has_model_id`,`colour_id`,`price`,`qty`,`description`,`title`,`condition_id`,`status_id`,`admin_email`,`datetime_added`,`delivery_fee_colombo`,`delivery_fee_other`) VALUES ('" . $category . "','" . $brand_has_model_id . "','" . $clr . "','" . $cost . "','" . $qty . "','" . $desc . "','" . $title . "','" . $condition . "','" . $status . "','" . $email . "','" . $date . "','" . $dwc . "','" . $doc . "') ");
            ...
            for ($x = 0; $x < $length; $x++) {
                if (isset($_FILES["image" . $x])) {
                    ...
                    if (in_array($file_extention, $allowed_img_extentions)) {
                        ...
                        Database::iud("INSERT INTO `images` (`code`,`product_id`) VALUES ('" . $file_name2 . "','" . $product_id  . "')");
                    } else {
