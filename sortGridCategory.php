    ...
    <ul>
        <li>
            <a <?php if ($pageno <= 1) {
                ...
                ?> onclick="sortGridCategory('<?php echo $search; ?>','<?php echo ($pageno - 1); ?>');" <?php } ?>>
        ...
        ?>
                ...
                <li>
                    <a class="active" onclick="sortGridCategory('<?php echo $search; ?>','<?php echo ($x); ?>');"><?php echo $x; ?></a>
                </li>
            ...
            ?>
                ...
                <li>
                    <a onclick="sortGridCategory('<?php echo $search; ?>','<?php echo ($x); ?>');"><?php echo $x; ?></a>
                </li>
