...
<head>
    ...
    <title>About Us - AlphaTech</title>
...
<body class="main-dark">
    ...
    <div id="mainSearchResult">
        ...
        <div class="progressbar-section section-top-gap-100" class="main-dark">
            <div class="container">
                    ...
                    <div class="col-md-6">
                        <div class="custom-progress m-t-40">
                            <div class="skill-progressbar" data-aos="fade-up" data-aos-delay="0">
                                ...
                                <div class="line-progressbar" data-percentage="75" data-progress-color="#ff365d"></div>
                            </div>
                            <div class="skill-progressbar" data-aos="fade-up" data-aos-delay="200">
                                <h6 class="font--semi-bold m-b-15">Ideas</h6>
                                <div class="line-progressbar" data-percentage="86" data-progress-color="#ff365d"></div>
                            </div>
                            <div class="skill-progressbar" data-aos="fade-up" data-aos-delay="400">
                                <h6 class="font--semi-bold m-b-15">Design</h6>
                                <div class="line-progressbar" data-percentage="97" data-progress-color="#ff365d"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--  Start  Team Section    -->
        <div class="team-section section-top-gap-100 secton-fluid" class="main-dark">
                ...
                <div class="container">
                    <div class="row mb-n6">
                        <div class="col-xl-3 mb-5">
                            <div class="team-single bg-dark" data-aos="fade-up" data-aos-delay="0">
                                <div class="team-img">
                                    <img class="img-fluid rounded-circle" src="assets/images/team/tch2.png" alt="">
                                </div>
                                <div class="team-content">
                                    <h6 class="team-name font--bold mt-5">Mark Ruffalo</h6>
                                    <span class="team-title">Software Engineer</span>
                        ...
                        <div class="col-xl-3 mb-5">
                            <div class="team-single bg-dark" data-aos="fade-up" data-aos-delay="200">
                                <div class="team-img">
                                    <img class="img-fluid rounded-circle" src="assets/images/team/tch3.png" alt="">
                                </div>
                                <div class="team-content">
                                    <h6 class="team-name font--bold mt-5">Brie Larson</h6>
                        ...
                        <div class="col-xl-3 mb-5">
                            <div class="team-single bg-dark" data-aos="fade-up" data-aos-delay="400">
                                <div class="team-img">
                                    <img class="img-fluid rounded-circle" src="assets/images/team/tch4.png" alt="">
                                </div>
                                <div class="team-content">
                                    <h6 class="team-name font--bold mt-5">Chris Hemsworth</h6>
                                    <span class="team-title">Technician</span>
                                    <ul class="team-social pos-absolute">
                                        <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                                        <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                                        <li><a href="#"><i class="ion-social-instagram"></i></a></li>
                        ...
                        <div class="col-xl-3 mb-5">
                            <div class="team-single bg-dark" data-aos="fade-up" data-aos-delay="600">
                                <div class="team-img">
                                    <img class="img-fluid rounded-circle" src="assets/images/team/tch5.png" alt="">
                                </div>
                                <div class="team-content">
                                    <h6 class="team-name font--bold mt-5">Jeremy Renner</h6>
