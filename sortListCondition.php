    ...
    <ul>
        <li>
            <a <?php if ($pageno <= 1) {
                ...
                ?> onclick="sortListCondition('<?php echo $search; ?>','<?php echo ($pageno - 1); ?>');" <?php } ?>>
        ...
        ?>
                ...
                <li>
                    <a class="active" onclick="sortListCondition('<?php echo $search; ?>','<?php echo ($v); ?>');"><?php echo $v; ?></a>
                </li>
            ...
            ?>
                ...
                <li>
                    <a onclick="sortListCondition('<?php echo $search; ?>','<?php echo ($v); ?>');"><?php echo $v; ?></a>
                </li>
