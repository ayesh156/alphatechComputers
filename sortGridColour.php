    ...
    <ul>
        <li>
            <a <?php if ($pageno <= 1) {
                ...
                ?> onclick="sortGridColour('<?php echo $search; ?>','<?php echo ($pageno - 1); ?>');" <?php } ?>>
        ...
        ?>
                ...
                <li>
                    <a class="active" onclick="sortGridColour('<?php echo $search; ?>','<?php echo ($x); ?>');"><?php echo $x; ?></a>
                </li>
            ...
            ?>
                ...
                <li>
                    <a onclick="sortGridColour('<?php echo $search; ?>','<?php echo ($x); ?>');"><?php echo $x; ?></a>
                </li>
