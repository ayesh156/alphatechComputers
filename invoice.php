                    ...
                    <div class="col-11">
                        ...
                        <div class="row extra-info pt-3">
                            <div class="col-7">
                                ...
                                ?>
                                <p>Invoice ID: <br><span><?php echo $invoice_data["invoice_id"];
                                                            ?></span></p>
                            </div>
                            <div class="col-5">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $oid;
                                    ?></td>
                                <td>Rs.<?php echo $product_data["price"];
                                        ?>.00</td>
                                <td><?php echo $invoice_data["qty"];
                                    ?></td>
                                <?php
                                $total = ($product_data["price"] * $invoice_data["qty"]);
                                ?>
